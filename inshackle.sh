C #!/bin/bash
# Inshackle v2.0
# recoded by: AK_infosol
# github.com/akwd1909/inshackle.git
...
printf "      \e[1;31m[\e[0m\e[1;77mv1.0\e[0m\e[1;31m]\e[0m\e[1;77m recoded by ak_the_geek (thanks to AK_Infosol )\e[0m\n"
}
